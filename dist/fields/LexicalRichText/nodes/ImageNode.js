...
class ImageNode extends lexical_2.DecoratorNode {
    static getType() {
        return 'upload';
    }
    static clone(node) {
...
function $createImageNode(rawImagePayload, extraAttributes, showCaption, caption, captionsEnabled) {
    return (0, lexical_2.$applyNodeReplacement)(new ImageNode(rawImagePayload, extraAttributes, showCaption, caption, captionsEnabled));
}
