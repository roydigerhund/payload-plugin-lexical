...
function BlockFormatDropDown({ editor, blockType, rootType, disabled = false, editorConfig, }) {
    ...
    return (React.createElement(DropDown_1.default, { disabled: disabled, buttonClassName: "toolbar-item block-controls", buttonIconClassName: `icon block-type ${blockType}`, buttonLabel: blockTypeToBlockName[blockType], buttonAriaLabel: "Formatting options for text style" },
        editorConfig.toggles.blocks.includes('paragraph') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'paragraph')}`, onClick: formatParagraph },
            React.createElement("i", { className: "icon paragraph" }),
            React.createElement("span", { className: "text" }, "Normal"))),
        editorConfig.toggles.blocks.includes('h1') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'h1')}`, onClick: () => formatHeading('h1') },
            React.createElement("i", { className: "icon h1" }),
            React.createElement("span", { className: "text" }, "Heading 1"))),
        editorConfig.toggles.blocks.includes('h2') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'h2')}`, onClick: () => formatHeading('h2') },
            React.createElement("i", { className: "icon h2" }),
            React.createElement("span", { className: "text" }, "Heading 2"))),
        editorConfig.toggles.blocks.includes('h3') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'h3')}`, onClick: () => formatHeading('h3') },
            React.createElement("i", { className: "icon h3" }),
            React.createElement("span", { className: "text" }, "Heading 3"))),
        editorConfig.toggles.blocks.includes('h4') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'h4')}`, onClick: () => formatHeading('h4') },
            React.createElement("i", { className: "icon h4" }),
            React.createElement("span", { className: "text" }, "Heading 4"))),
        editorConfig.toggles.blocks.includes('h5') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'h5')}`, onClick: () => formatHeading('h5') },
            React.createElement("i", { className: "icon h5" }),
            React.createElement("span", { className: "text" }, "Heading 5"))),
        editorConfig.toggles.blocks.includes('h6') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'h6')}`, onClick: () => formatHeading('h6') },
            React.createElement("i", { className: "icon h6" }),
            React.createElement("span", { className: "text" }, "Heading 6"))),
        editorConfig.toggles.blocks.includes('bullet') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'bullet')}`, onClick: formatBulletList },
            React.createElement("i", { className: "icon bullet-list" }),
            React.createElement("span", { className: "text" }, "Bullet List"))),
        editorConfig.toggles.blocks.includes('number') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'number')}`, onClick: formatNumberedList },
            React.createElement("i", { className: "icon numbered-list" }),
            React.createElement("span", { className: "text" }, "Numbered List"))),
        editorConfig.toggles.blocks.includes('check') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'check')}`, onClick: formatCheckList },
            React.createElement("i", { className: "icon check-list" }),
            React.createElement("span", { className: "text" }, "Check List"))),
        editorConfig.toggles.blocks.includes('quote') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'quote')}`, onClick: formatQuote },
            React.createElement("i", { className: "icon quote" }),
            React.createElement("span", { className: "text" }, "Quote"))),
        editorConfig.toggles.blocks.includes('code') && (React.createElement(DropDown_1.DropDownItem, { className: `item ${dropDownActiveClass(blockType === 'code')}`, onClick: formatCode },
